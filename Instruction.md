...
There are two types of tests - Jest/Supertest for the backend and Vitest/React Testing Library for the frontend.<br/>

To validate the backend using Jest/Supertest, open the terminal and enter the commands:<br/>

cd backend <br/>
npx jest <br/>

To validate the frontend using Vitest/React Testing, open the terminal and enter the commands: <br/>
